...
<script type="text/javascript">
	...
	function send(){
		...
		textarea.innerHTML+="<div class='w3-yellow w3-border w3-round-large w3-pading-small' id='me' style='width:"+((inputMessage.value.length*12)+45)+"px;'>나: "+inputMessage.value+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><br>";
